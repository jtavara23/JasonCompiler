...
//12. VarDecls ::= (VarDecl)+
  static final public void VarDecls(String idTipo, boolean origenRecord) throws ParseException {
    label_2:
    while (true) {
...
//13. VarDecl ::= DataType IdList ;
  static final public void VarDecl(String idTipo, boolean origenRecord) throws ParseException {
        Token t;
    t = DataType();
...
//15. IdList ::= identifier {, identifier}
  static final public void IdList(String idTipo, Token dataT, boolean origenRecord) throws ParseException {
        Token t;
    t = Identifier(true);
